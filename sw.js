/* Wadhwani Registration V16 service worker — notifications only; no navigation interception */
const APP_VERSION = 'wadhwani-v16-console-fix';
...
/* No fetch event is registered in V16. The service worker exists only for notifications, so normal browser navigation and assets go directly to the network. */
