/* Wadhwani Registration V12 service worker — PWA shell + Firebase background push */
const APP_VERSION = 'wadhwani-v12';
...
/* Pass requests through to the network. Wadhwani intentionally avoids caching
 * Google Sheets API responses. Student identity is remembered by the app page only; it is not cached by the service worker. */
