...
(() => {
   ...
   */
  const APPS_SCRIPT_WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbxwPDfc2xiKrTNm1bNBP9BSpK3l4Fju9kVyN2aINGF8bvD7JT8G2cXDGfiM2nkPg0r1xA/exec';
  ...
  function getStudentScheduleEnd(student) {
    const slot = getSlot(student?.slotId);
    return new Date(`${normalizeDateKey(student?.date)}T${normalizeClock(student?.rotationEnd || slot?.end)}:00+08:00`);
  }
